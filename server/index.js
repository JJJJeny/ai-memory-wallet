...
if (!['127.0.0.1','localhost','::1'].includes(host) && process.env.ALLOW_DEV_MAGIC_LINK !== 'false') {
  throw new Error('Development sign-in must remain on localhost. Configure real email delivery before hosting publicly.');
}
