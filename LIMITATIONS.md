...
- GitHub Pages is a public browser-only demo. Cards stay in that browser (localStorage when available). They are not private. This is not the full server wallet. Do not put real private cards there.
